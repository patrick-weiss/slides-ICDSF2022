...
output:
  xaringan::moon_reader:
    css: [useR, useR-fonts, "standard.css"]
    lib_dir: libs
    yolo: false
    nature:
...
meta() %>%
  meta_general(
    description = "Presentation slides for 'Tidy Finance with R' at ICDSF 2022.",
    generator = "xaringan and remark.js"
  ) %>% 
  meta_name("github-repo" = "patrick-weiss/slides-ICDSF2022") %>% 
  meta_social(
...
- \#TidyFinance **courses** online and on-site in the future.

]

.pull-right[

<middle><center><img src="images/signed_contract.jpg" alt="A partial view of the first page of a contract with a pen." width="520" height="300"/></center></middle>
